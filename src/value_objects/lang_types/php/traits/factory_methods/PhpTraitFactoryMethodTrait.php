...
use tacddd\value_objects\lang_types\php\traits\adjusters\PhpTraitAdjusterTrait;

/**
 * 言語型：PHP：trait：factory method
 */
trait PhpTraitFactoryMethodTrait
{
    use PhpTraitAdjusterTrait;
