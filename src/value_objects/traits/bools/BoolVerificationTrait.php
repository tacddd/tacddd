...
namespace tacddd\value_objects\traits\bools;
 ...
 * 検証特性：真偽値
 */
trait BoolVerificationTrait
{
    /**
     * 値がこのオブジェクトで使えるかどうかを返します。
     *
     * @return self|bool $value 値
     * @return bool      値がこのオブジェクトで使えるかどうか
     */
    public static function verify(self|bool $value): bool
    {
     ...
     *
     * @param  self|bool        $value 値
     * @return ValidationResult 検証結果
     */
    public static function validate(self|bool $value): ValidationResultInterface
    {
        return static::verify($value) ? new ValidationResultSuccess() : ValidationResultFailure::of(
            static::getName(),
     ...
     * @param self|bool $value 値
     */
    public static function ensure(self|bool $value): void
    {
