...
use tacddd\value_objects\lang_types\php\abstracts\AbstractPhpNullableString;
use tacddd\value_objects\lang_types\php\PhpNullableString;
use tacddd\value_objects\lang_types\php\traits\factory_methods\PhpNullableStringFactoryMethodTrait;

/**
 * 言語型：PHP：nullable string
 * @internal
 */
#[CoversClass(AbstractPhpNullableString::class)]
#[CoversClass(PhpNullableString::class)]
class PhpNullableStringTest extends AbstractValueObjectTestCase
{
    ...
    public static function adjustDataProvider(): iterable
    {
        foreach (TypeDataSet::typeDataSetWithExclusion([
            ...
            foreach ($type_data_set as $data_set) {
                yield [
                    $data_set['value'],
                    $data_set['value'] === null ? $data_set['value'] : (string) $data_set['value'],
                ];
            }
        }
    }
    ...
    public static function getClassSpec(): AbstractValueObjectClassSpec
    {
        return new class() extends AbstractValueObjectClassSpec {
            ...
            {
                return PhpNullableString::class;
            }
            ...
            {
                return [
                    AbstractPhpNullableString::class,
                ];
            }
            ...
            {
                return [
                    PhpNullableStringFactoryMethodTrait::class,
                ];
            }
        };
    }
