...
/**
 * 言語型：PHP：nullable float：adjuster method
 */
trait PhpNullableFloatAdjusterTrait
{
    /**
     * adjust
     *
     * @param  null|string|int|float $value 値
     * @return null|float            調整済みの値
     */
    public static function adjust(null|string|int|float $value): ?float
    {
        if ($value === null) {
            return $value;
        }
