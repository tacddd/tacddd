...
use tacddd\value_objects\lang_types\php\abstracts\AbstractPhpBool;
use tacddd\value_objects\lang_types\php\PhpBool;
use tacddd\value_objects\lang_types\php\traits\factory_methods\PhpBoolFactoryMethodTrait;

/**
 * 言語型：PHP：bool
 * @internal
 */
#[CoversClass(AbstractPhpBool::class)]
#[CoversClass(PhpBool::class)]
class PhpBoolTest extends AbstractValueObjectTestCase
{
    /**
     * アジャスタ用データプロバイダ
     *
    ...
    {
        foreach (TypeDataSet::typeDataSetWithInclusion(['bool']) as $type_data_set) {
    ...
    public static function getClassSpec(): AbstractValueObjectClassSpec
    {
        return new class() extends AbstractValueObjectClassSpec {
            ...
            {
                return [
                    PhpBoolFactoryMethodTrait::class,
                ];
            }
        };
    }
