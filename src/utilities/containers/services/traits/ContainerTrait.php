...
use tacddd\utilities\containers\exceptions\ContainerException;
...
trait ContainerTrait
{
    ...
    public function get(string $id): object
    {
        ...
        if ($this->configs[$id]['only_create'] ?? false) {
            throw new ContainerException(ContainerService::getStringService()->buildDebugMessage('このIDはcreateメソッドのみで取得できます。', $id));
        }
