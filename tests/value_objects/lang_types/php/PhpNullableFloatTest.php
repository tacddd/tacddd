...
use tacddd\value_objects\lang_types\php\abstracts\AbstractPhpNullableFloat;
use tacddd\value_objects\lang_types\php\PhpNullableFloat;
use tacddd\value_objects\lang_types\php\traits\factory_methods\PhpNullableFloatFactoryMethodTrait;

/**
 * 言語型：PHP：nullable float
 * @internal
 */
#[CoversClass(AbstractNullablePhpNullableFloat::class)]
#[CoversClass(PhpNullableFloat::class)]
class PhpNullableFloatTest extends AbstractValueObjectTestCase
{
    ...
    public static function getClassSpec(): AbstractValueObjectClassSpec
    {
        return new class() extends AbstractValueObjectClassSpec {
            ...
            {
                return [
                    AbstractPhpNullableFloat::class,
                ];
            }
            ...
            {
                return [
                    PhpNullableFloatFactoryMethodTrait::class,
                ];
            }
        };
    }
