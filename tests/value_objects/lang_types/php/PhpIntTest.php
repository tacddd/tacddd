...
use tacddd\value_objects\lang_types\php\PhpInt;
 ...
 * @internal
 */
#[CoversClass(AbstractPhpInt::class)]
#[CoversClass(PhpInt::class)]
class PhpIntTest extends AbstractValueObjectTestCase
{
    ...
    public static function getClassSpec(): AbstractValueObjectClassSpec
    {
        return new class() extends AbstractValueObjectClassSpec {
            ...
            {
                return [
                    PhpIntFactoryMethodTrait::class,
                ];
            }
        };
    }
