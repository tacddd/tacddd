...
use tacddd\value_objects\lang_types\php\traits\adjusters\PhpClassAdjusterTrait;

/**
 * 言語型：PHP：class：factory method
 */
trait PhpClassFactoryMethodTrait
{
    use PhpClassAdjusterTrait;
