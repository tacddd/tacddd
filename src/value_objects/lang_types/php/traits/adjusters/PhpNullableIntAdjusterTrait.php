...
/**
 * 言語型：PHP：nullable int：adjuster method
 */
trait PhpNullableIntAdjusterTrait
{
    /**
     * adjust
     *
     * @param  null|string|int|float $value 値
     * @return null|int              調整済みの値
     */
    public static function adjust(null|string|int|float $value): ?int
    {
        if ($value === null) {
            return $value;
        }
