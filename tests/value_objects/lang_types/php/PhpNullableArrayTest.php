...
use tacddd\value_objects\lang_types\php\PhpNullableArray;
 ...
 * @internal
 */
#[CoversClass(AbstractPhpNullableArray::class)]
#[CoversClass(PhpNullableArray::class)]
class PhpNullableArrayTest extends AbstractValueObjectTestCase
{
    ...
    public static function getClassSpec(): AbstractValueObjectClassSpec
    {
        return new class() extends AbstractValueObjectClassSpec {
            ...
            {
                return 'IteratorAggregate|Iterator|array|null';
            }
            ...
            {
                return [
                    AbstractPhpNullableArray::class,
                ];
            }
            ...
            public function getExpectedUsingTraits(): array
            {
                return [
                    ...
                    PhpNullableArrayFactoryMethodTrait::class,
                ];
            }
        };
    }
