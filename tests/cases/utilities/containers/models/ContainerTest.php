...
namespace tacddd\tests\cases\utilities\containers\models;
...
class ContainerTest extends AbstractTestCase
{
    ...
    public function container(): void
    {
        ...
        // ==============================================
        $this->assertInstanceOf(Container::class, $container->set(BoolTraitDummay::class, BoolTraitDummay::class, true, [true]));
        ...
        $this->assertInstanceOf(Container::class, $container->set(BoolTraitDummay::class, BoolTraitDummay::class, false, [true]));
