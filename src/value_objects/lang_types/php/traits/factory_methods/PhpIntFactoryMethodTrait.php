...
use tacddd\value_objects\lang_types\php\traits\adjusters\PhpIntAdjusterTrait;

/**
 * 言語型：PHP：int：factory method
 */
trait PhpIntFactoryMethodTrait
{
    use PhpIntAdjusterTrait;
